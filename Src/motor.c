...
volatile uint8_t Ki = 8;             // Integral gain
...
int motor_speed_to_rpm(int speed)
{
    return speed * 1;
}
...
void PI_update(void)
{
    ...
    error = motor_speed_to_rpm(target_rpm) - motor_speed;
    ...
    int16_t output = (error * Kp + error_integral * Ki); // Change this!
